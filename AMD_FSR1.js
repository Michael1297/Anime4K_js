...
// NOTE: This UL userscript currently reuses the stable CNN-M x2 pipeline
...
async function loadRuntimeShadersOrThrow() {
    const parsed = await BilibiliShaderRuntime.loadAnime4KPassesOrThrow(SHADER_URL, 2);
    const fsrPasses = BilibiliShaderRuntime.buildFsr1Passes(parsed);
    [frag0, frag1, frag2, frag3, frag4, frag5, frag6, frag7, frag8, frag9] = fsrPasses;
